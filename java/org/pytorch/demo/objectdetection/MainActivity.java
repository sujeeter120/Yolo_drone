...
public class MainActivity extends AppCompatActivity implements Runnable {
    ...
    private String[] mTestImages = {"test1.jpg", "test2.jpg"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonTest.setText(("Test Image 1/2"));
        ...
        try {
            mModule = mModule.load(MainActivity.assetFilePath(getApplicationContext(), "best.torchscript.ptl"));
